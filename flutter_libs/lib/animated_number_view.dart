              ...
              child: Stack(children: [
                Transform.translate(
                    ...
                    child: Opacity(
                        ...
                        child: Text(prevLetter == null ? "" : prevLetter!, style: TextStyle(fontSize: 80, fontWeight: FontWeight.bold)))),
                Transform.translate(
                    offset: Offset(0, 50 - controller.value * 50),
                    child: Opacity(
                        opacity: controller.value,
                        child: Text(currentLetter == null ? "" : currentLetter!, style: TextStyle(fontSize: 80, fontWeight: FontWeight.bold))))
              ]));
        });
  }
}
