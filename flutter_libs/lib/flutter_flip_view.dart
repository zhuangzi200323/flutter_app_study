...
class FlipView extends StatefulWidget {
  ...
  const FlipView({
    ...
    AxisDirection goBackDirection = AxisDirection.left,
    AxisDirection goFrontDirection = AxisDirection.left,
  })  : this.goBackDirection = goBackDirection,
        this.goFrontDirection = goFrontDirection,
        super(key: key);
