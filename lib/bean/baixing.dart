...
class ShopInfo {
  ...
  static List<ShopInfo> fromMapList(dynamic mapList) {
    List<ShopInfo> list = List.empty(growable: true);//List(mapList.length);
...
class Goods {
  ...
  static List<Goods> fromMapList(dynamic mapList) {
    List<Goods> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class GoodsInfo {
  ...
  static List<GoodsInfo> fromMapList(dynamic mapList) {
    List<GoodsInfo> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
