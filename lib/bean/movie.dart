...
class Movie {
  ...
  static List<Movie> fromMapList(dynamic mapList) {
    List<Movie> list = List.empty(growable: true);//List(mapList.length);
...
class Celebrity {
  ...
  static List<Celebrity> fromMapList(dynamic mapList) {
    List<Celebrity> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Casts {
  ...
  static List<Casts> fromMapList(dynamic mapList) {
    List<Casts> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Photos {
  ...
  static List<Photos> fromMapList(dynamic mapList) {
    List<Photos> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Reviews {
  ...
  static List<Reviews> fromMapList(dynamic mapList) {
    List<Reviews> list = List.empty(growable: true);//new List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Author {
  ...
  static List<Author> fromMapList(dynamic mapList) {
    List<Author> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Avatars {
  ...
  static List<Avatars> fromMapList(dynamic mapList) {
    List<Avatars> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Videos {
  ...
  static List<Videos> fromMapList(dynamic mapList) {
    List<Videos> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Source {
  ...
  static List<Source> fromMapList(dynamic mapList) {
    List<Source> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Rating {
  ...
  static List<Rating> fromMapList(dynamic mapList) {
    List<Rating> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Details {
  ...
  static List<Details> fromMapList(dynamic mapList) {
    List<Details> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Clips {
  ...
  static List<Clips> fromMapList(dynamic mapList) {
    List<Clips> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
...
class Images {
  ...
  static List<Images> fromMapList(dynamic mapList) {
    List<Images> list = List.empty(growable: true);//List(mapList.length);
    for (int i = 0; i < mapList.length; i++) {
      list[i] = fromMap(mapList[i]);
    }
    return list;
