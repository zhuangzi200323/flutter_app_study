...
class BookModel extends ChangeNotifier {
  late BookShelfDBHelper dbHelper;
  ...
  Future updateBook(
    ...
    if (null != _book) {
      Books book = Books(
        ...
        title: _book!.title,
        cover: _book!.cover,
        progress: progress == null ? 0.0 : _book!.progress!,
        chapterIndex: chapterIndex = _book!.chapterIndex!,
        chapterLink: link = _book!.chapterLink!,
        offset: offset == null ? 0 : _book!.offset!,
        totalChapter: totalChapter == null ? 0 : _book!.totalChapter!,
      );
