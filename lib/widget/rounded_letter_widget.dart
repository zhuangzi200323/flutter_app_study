...
import '../roundedletter/click_listener.dart';
import '../roundedletter/rounded_letter.dart';
import '../roundedletter/shape_type.dart';
...
class _RoundedLetterWidgetState extends State<RoundedLetterWidget> {
  ...
  ClickListener? listener = SampleClickListener();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            child: getListWithRoundedLetters()
        )
    );
  }
